...
const Banner = () => {
  return (
    <div className="w-full overflow-hidden relative">
      ...
      <div className="absolute -top-3 right-4 laptop:right-[60px] laptop-md:right-[390px] laptop-lg:right-[90px] app:right-[400px] flex items-center justify-center h-full z-20">
        <BannerCover />
      </div>
    </div>
  );
